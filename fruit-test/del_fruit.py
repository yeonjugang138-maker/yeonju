...
from PyQt5.QtWidgets import (
    QApplication, QDialog, QMessageBox, QTableWidgetItem, QListWidgetItem
)
...
class FruitDelete(QDialog, form_class):
    ...
    def _reflow(self):
        ...
        new_width = max(self.search_del.x() - le_og.x() - margin, 60)
        self.lineEdit.setGeometry(le_og.x(), bottom_y, new_width, le_og.height())


    def load_fruit(self, keyword=None):
    ...
    def search_fruit(self):
        ...
        self.load_fruit(search_text if search_text else None)
